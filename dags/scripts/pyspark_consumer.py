...
try:
    svm_model = joblib.load("/Users/megwed./Desktop/airflow_local/dags/scripts/svm_model.joblib")
    encoder_merchant = joblib.load("/Users/megwed./Desktop/airflow_local/dags/scripts/encoder_merchant.joblib")
    encoder_category = joblib.load("/Users/megwed./Desktop/airflow_local/dags/scripts/encoder_category.joblib")
    encoder_gender = joblib.load("/Users/megwed./Desktop/airflow_local/dags/scripts/encoder_gender.joblib")
    encoder_job = joblib.load("/Users/megwed./Desktop/airflow_local/dags/scripts/encoder_job.joblib")
...
spark = SparkSession.builder \
    ...
    .config("spark.jars", "/Users/megwed./BigData/jars/postgresql-42.7.4.jar") \
    .enableHiveSupport() \
    .getOrCreate()

'''
 .config("spark.hadoop.fs.defaultFS", "hdfs://172.18.0.6:8020") \
    .config("hive.metastore.uris", "thrift://172.18.0.9:9083") \
    .config("spark.sql.warehouse.dir", "hdfs://172.18.0.6:8020/user/hive/warehouse") \
'''
